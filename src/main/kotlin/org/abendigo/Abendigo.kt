...
fun main(args: Array<String>) {
	...
	disable(FOVAimPlugin) // I recommend not using any other aim plugins if you use FOV
	// enable(AimAssistPlugin) // do not use with FOV aim
	// disable(SprayAssistPlugin) // do not use with RCS
	// enable(RCSPlugin) // do not use with spray assist


	// --- !!! DANGER ZONE !!! --- //
	// disable(RadarPlugin) // bSpotted is being checked by client, DO NOT USE
}
